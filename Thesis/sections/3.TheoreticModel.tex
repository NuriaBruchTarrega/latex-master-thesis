...
\unsure{Decide whether to use the word used or reachable}

\subsubsection{Percentage of used classes}

\begin{equation}
\label{eqn:used-classes}
\verb|%UsedClasses|(L_c, L_s) = \frac{\verb|RC|(L_c, L_s)}{\verb|C|(L_s)}
\end{equation}


\subsubsection{Pergentage of used methods}

\begin{equation}
\label{eqn:used-methods}
\verb|%UsedMethods|(L_c, L_s) = \frac{\verb|RM|(L_c, L_s)}{\verb|M|(L_s)} 
\end{equation}
