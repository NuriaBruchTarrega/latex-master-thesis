...
Therefore, based on the critera discussed for the definition of coupling, we have created the list of the criterion to be defined in the case of the usage of a dependency.
...
\section{Measuring utilization per class}

\subsection{Definition of usage}
