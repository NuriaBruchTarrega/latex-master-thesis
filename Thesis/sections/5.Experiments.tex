...
In Table \cn{table:comparison-results}, there are the results for each one of the client libraries used in the experiments.
...
%% Unused: lucene: not shipped with maven, empty dependency,
