...
\begin{enumerate}
  ...
  \item \textbf{About the visualizations:} The section after the demonstration contains questions about the tool itself and the designed visualizations.
  \item \textbf{About the metrics:} The last section is focused on the designed metrics, and the clarity and comprehensibility of these, as well as the actionability.
\end{enumerate}
...
\begin{table}[ht!]
    ...
    \hline
    Question & Section & Type of question \\
    \hline
    \end{tabularx}
    \end{center}
