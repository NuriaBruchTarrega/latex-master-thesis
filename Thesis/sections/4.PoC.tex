...
\subsection{Transitive Method Invocation Coupling}
...
The calculation of \texttt{TAC} is very similar to the calculation of \texttt{TMIC} but using the ac classes instead of the mic behaviors. The pseudo-code of the \textit{BFS} for the \texttt{TAC} is in Figure \ref{fig:tree-traversing-tac}\unsure{Should I remove this pseudo-code, is it repetitive?}.
...
\label{fig:algorithm-direct-usage-3}
\end{figure}
