...
When describing the relationship in which a library uses another, all the papers \unsure{relevant literature uses ...} use the term dependency. Then, depending on the focus of the research of each paper, \unsure{owever, different types of dependencies are defined depending on the ...} different types of dependencies are defined.

\unsure{Should I explain all the different types of dependencies here, or only those that I will use during the thesis?}
\todocontent{I would say yes, give an overview of the variety of types of dependencies, but focus only on those you will be using (by having a subsection for each)}
